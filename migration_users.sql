-- Script de migración de datos para usuarios (Alumnos y Administradores)

-- Limpiar tabla antes de migrar (OPCIONAL - SOLO PARA PRUEBAS)
-- DELETE FROM usuarios;

-- 1. Insertar Administradores solicitados
...
-- 2. Insertar Alumnos desde alumnos.json
